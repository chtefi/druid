...
* `bin/` - scripts that will be used for this setup.
...
Next, you can start up the Druid processes. This tutorial runs every Druid process on the same system. In production, 
